...
class AdvancedBot(BaseBot):
    def __init__(self):
        ...
        self.emotes = {
            ...
            "263": "dance-spiritual",
            "264": "dance-anime",
            "265": "dance-swagbounce",
            "266": "dance-mine",
            "267": "dance-woah",
            "268": "dance-popularvibe",
            "269": "idle-laidBack",
            "270": "dance-tiktok2",
            "271": "dance-singleladies",
            "272": "dance-tiktok11",
            "273": "dance-griddy",
            "274": "idle-loop-tapdance",
            "275": "emote-astronaut",
            "276": "idle-toilet",
            "277": "idle_singing",
            "278": "dance-tiktok9",
            "279": "emote-teleporting",
            "280": "emote-telekinesis",
            "281": "dance-robotic",
            "282": "dance-hipshake",
            "283": "emote-blowkisses",
            "284": "idle-fighter",
            "285": "emote-fashionista",
            "286": "sit-idle-laidBack",
            "287": "dance-spiritual",
            ...
            "۲۶۳": "dance-spiritual",
            "۲۶۴": "dance-anime",
            "۲۶۵": "dance-swagbounce",
            "۲۶۶": "dance-mine",
            "۲۶۷": "dance-woah",
            "۲۶۸": "dance-popularvibe",
            "۲۶۹": "idle-laidBack",
            "۲۷۰": "dance-tiktok2",
            "۲۷۱": "dance-singleladies",
            "۲۷۲": "dance-tiktok11",
            "۲۷۳": "dance-griddy",
            "۲۷۴": "idle-loop-tapdance",
            "۲۷۵": "emote-astronaut",
            "۲۷۶": "idle-toilet",
            "۲۷۷": "idle_singing",
            "۲۷۸": "dance-tiktok9",
            "۲۷۹": "emote-teleporting",
            "۲۸۰": "emote-telekinesis",
            "۲۸۱": "dance-robotic",
            "۲۸۲": "dance-hipshake",
            "۲۸۳": "emote-blowkisses",
            "۲۸۴": "idle-fighter",
            "۲۸۵": "emote-fashionista",
            "۲۸۶": "sit-idle-laidBack",
            "۲۸۷": "dance-spiritual",
    ...
    async def on_chat(self, user: User, message: str):
        ...
        try:
            ...
            if msg_lower in self.emotes:
                ...
                await self.highrise.chat("👑 سازنده این بات: @nima_curly 👑")
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "666bc3d127dddf2a0fd2945a")
